...
const CurpGenerator = () => {
  const [persona, setPersona] = useState({
    ...
    apellidoPaterno: "",
    apellidoMaterno: "",
    genero: curp.GENERO.MASCULINO,
    fechaNacimiento: "",
    estado: curp.ESTADO.CHIAPAS,
  });
  ...
  const handleInputChange = (e) => {
    ...
    if (year < 1900 || year > 2024) {
      alert('Por favor, ingresa una fecha válida entre 1900 y 2024.');
      event.target.value = '';
      return;
    }
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="relative h-10 w-72 min-w-[200px] ">
          <select
            ...
            onChange={handleInputChange}
          >
            <option value={curp.GENERO.MASCULINO}>Masculino</option>
            <option value={curp.GENERO.FEMENINO}>Femenino</option>
          </select>
        ...
        <div className="py-8">
          ...
          <Modal
            ...
            className="bg-gray rounded-lg p-4 w-[500px] h-[300px] mx-auto flex items-center justify-center"
          >
            <div className="bg-gray-200 rounded flex flex-col items-center justify-center p-4">
              <ReCAPTCHA
                sitekey="6Le3sZ4pAAAAAFOmbWYYhFC_BLQgZhT1MN6-SdH8"
